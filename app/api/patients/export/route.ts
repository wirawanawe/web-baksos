    ...
    const excelData = patients.map((patient) => {
      ...
      return {
        ...
        'Tensi Darah (mmHg)': patient.tensi_darah_sistol && patient.tensi_darah_diastol
          ...
          : '',
        'Denyut Nadi (bpm)': patient.denyut_nadi || '',
        'Laju Pernapasan (x/menit)': patient.laju_pernapasan || '',
        'Suhu Tubuh (°C)': patient.suhu_tubuh || '',
        ...
        'Kesimpulan Kelayakan': patient.kesimpulan_kelayakan || '',
        'Saran Medis': patient.saran_medis || '',
